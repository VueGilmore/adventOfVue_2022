Skip to content Pull requests Issues Codespaces Marketplace Explore @danielkellyio danielkellyio / secret-santa-eric
Private Code Issues Pull requests Actions Projects Security Insights Settings secret-santa-eric/src/components/UsMap.vue
Daniel Kelly init commit Latest commit 73478f1 Dec 16, 2019 History 0 contributors 190 lines (189 sloc) 25.4 KB
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 959 593" width="600" style="max-width: 100%">
    <g class="state">
      <path
        id="AL"
        :class="{ highlighted: highlights.al }"
      ...
      <path
        id="KY"
        :class="{ highlighted: highlights.ky }"
      ...
      <path
        id="ND"
        :class="{ highlighted: highlights.nd }"
      ...
      <path
        id="TX"
        :class="{ highlighted: highlights.tx }"
      ...
      <path
        id="VA"
        :class="{ highlighted: highlights.va }"
...
export default {
  ...
  mounted() {
    Object.keys(this.highlights).forEach(highlight => {
      const rand = Math.random() * 1500
      setTimeout(() => {
        this.highlights[highlight] = true
      }, rand)
    })
  },
}
